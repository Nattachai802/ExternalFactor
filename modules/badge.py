...
def evaluate(current_weather_id: int | None, pop_periods: list[dict],
    ...
    if disaster_alert:
        ...
        line2 = f"ค่าฝุ่นอยู่ในระดับมีผลกระทบต่อสุขภาพ ({aqi}) — อาจส่งผลต่อพื้นที่นั่งกลางแจ้งและลูกค้ากลุ่มเสี่ยง"
...
def demo():
    ...
    assert "(180)" in out["บรรทัดที่ 2"], "ข้อความค่าฝุ่นต้องเป็นตัวเลขล้วนในวงเล็บ ตามสเปกใหม่"
